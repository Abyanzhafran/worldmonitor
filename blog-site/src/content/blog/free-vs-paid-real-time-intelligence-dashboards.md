...
- **Your agents need the data.** MCP access with a documented tool surface (64 tools in World Monitor's case) lets Claude or GPT query live intelligence under one key.
...
| Pro | $39.99/month or $359.99/year | Analysts: WM Analyst chat with citations, Scenario Engine, Route Explorer, AI digest, MCP access with 64 tools |
