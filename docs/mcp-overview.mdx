...
See the [Tool catalog](#tool-catalog) above for the complete list of 64 tools, or the [MCP Tools Reference](/mcp-tools-reference) for per-tool details.

## Prompts and resources

In addition to the 64 tools, WorldMonitor exposes MCP prompts and resources so clients can discover common workflows and address stable data slices without inventing tool plans from scratch.
