...
- **MCP server (recommended):** `https://worldmonitor.app/mcp` — Streamable HTTP, 64 tools; issue `tools/list` for the live inventory. Server card: https://worldmonitor.app/.well-known/mcp/server-card.json
