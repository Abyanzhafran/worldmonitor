...
- Real-time global map with 56 data layers, 547+ observed upstream hosts, and 500+ curated news feeds
...
- 64-tool MCP server so AI agents can query everything above
